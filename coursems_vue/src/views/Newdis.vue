    ...
    <el-header style=" text-align: left;font-size: 10px"  class="mh" height="50px">
      <el-container>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right" class="bre">
          ...
          <el-breadcrumb-item  @click="refresh"><span >发帖页面</span></el-breadcrumb-item>
      ...
      <el-container class="container">
        <div class ="content1">
          ...
          <el-form-item label="内容" prop="description">
            <el-input type="textarea" rows="13" v-model="ruleForm.description"></el-input>
          </el-form-item>
          <el-form-item>
  ...
  methods: {
    ...
    submitForm(formName){
      this.$refs[formName].validate(async valid =>{
        if(valid){
          const res = await ForumService.post(this.ruleForm.title, this.ruleForm.description,localStorage.id);
