<template>
  ...
  <el-container class="final">
    <el-header style=" text-align: left;font-size: 10px" class="mh" height="50px">
      <el-container>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right" class="bre">
          ...
          <el-breadcrumb-item>上传作业</el-breadcrumb-item>
    ...
    <el-container class="main">
      ...
      <el-container id="content" style="align-items: center">
        <el-card style="width: 100%;position: relative;  height: 100vh;">

          <el-descriptions title="作业1" direction="vertical" :column="4" border>
            <el-descriptions-item label="作业题目" id="name" width="25%">第一章习题</el-descriptions-item>
            <el-descriptions-item label="截止日期" id="ddl" width="25%">2021/9/30</el-descriptions-item>
            <el-descriptions-item label="状态" id="state" width="25%">未提交</el-descriptions-item>
            <el-descriptions-item label="分数" id="score" width="25%">0</el-descriptions-item>
            <el-descriptions-item label="作业描述" id="describe">
              <p>1、完成第一章习题</p>
              <p>2、自行订正答案</p>
